...
impl Default for CleanupConfig {
    fn default() -> Self {
        Self {
            ...
            max_health_records_per_node: 1000,
            cleanup_interval_seconds: 120, // 2分钟
...
impl Default for CleanupResult {
    fn default() -> Self {
        Self {
            old_health_records_cleaned: 0,
            old_instances_cleaned: 0,
            excess_health_records_cleaned: 0,
