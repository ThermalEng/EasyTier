...
export default {
  ...
  async mounted() {
    ...
    try {
      ...
      console.log('Token verified successfully, loading nodes...')
  ...
  methods: {
    ...
    editNode(node) {
      console.log('编辑节点被点击:', node)
      this.editingNodeId = node.id
      this.editForm = node
      console.log('设置编辑表单:', this.editForm)
      this.editDialogVisible = true
      console.log('对话框应该显示:', this.editDialogVisible)
    },
